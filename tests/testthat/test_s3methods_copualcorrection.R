...
# expect_warning(res.dis.only <- copulaCorrection(formula=y~X1+X2+P1+P2|discrete(P1, P2),
#                                                data=dataCopDis2, verbose = FALSE, num.boots = 2),
...
#   expect_warning(res.dis.cont <- copulaCorrection(formula=y~X1+X2+P1+P2|discrete(P1)+continuous(P2),
#                                                  data=dataCopDisCont, verbose = FALSE, num.boots = 2),
#                  regexp = "It is recommended to run 1000 or more bootstraps.", all=TRUE)
