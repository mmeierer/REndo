...
tscope(formula, data, ...)
```
The tscope function implements the two-stage copula generated regressor approach by Yang, Qian, and Xie (2024). The first argument is the model formula, and the second is the dataset. Additional arguments are used to control the specifics of the estimation procedure. Please refer to the tscope function documentation for detailed usage instructions and parameter descriptions.
