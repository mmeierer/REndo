...
#' By being a step function, the value of \code{P^{*}} lies between 2 values, \code{\Phi^{-1}(H(P_{t}-1))} and \code{\Phi^{-1}(H(P_{t}))}. Since
#' the exact value is not known, a set of 250 simmulations are run thorugh the function \code{\link[REndo2:confint.rendo.pstar.lm]{confint}}
#' and the confidence interval of the estimated coefficients are returned.
#'}
#'
