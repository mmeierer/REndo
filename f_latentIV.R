...
#' Identification of the parameters relies on the distributional assumptions of the latent instruments as well as that of the endogenous regressor, $P_{t}$. 
#' Specifically, the endogenous regressor should have a non-normal distribution while the unobserved instruments, $Z$, should be discrete and have at least two groups with different means \citep{Ebbes2009}.
...
#' 
#' Ebbes P, Wedel M, Boeckenholt U (2009). “Frugal IV Alternatives to Identify the Parameter for an Endogeneous Regressor.” Journal of Applied Econometrics, 24(3), 446–468.
